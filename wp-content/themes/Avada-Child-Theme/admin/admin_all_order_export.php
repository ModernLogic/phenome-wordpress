...
function handle_custom_order_export()
{
    ...
    $product_ids = array(1020, 4403, 5962);
  ...
  $data[] = $row;
                        ...
                        foreach ($groupedData as $identifier => $details) {
                            ...
                            foreach ($details as $detail) {
                                ...
                                if ($label === "Add Secondary Test For Same Shed" || $label === "Pick 3 Tests") {
                                    ...
                                    if ($label === "Known Genetics") {
                                        $label = "Known Genetics";
                                    }
        ...
        foreach ($data as $row) {
            ...
            foreach ($row as $key => $value) {
                ...
                } elseif (in_array($key, ['Shade Id', 'Customer', 'Known Genetics'])) {
